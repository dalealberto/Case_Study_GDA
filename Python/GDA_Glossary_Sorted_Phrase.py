...
#glossary_sorted_by_phrase(glossary_dict)

# Create string variable to be used for writing to .txt file
glossary_sorted_by_phrase_string = glossary_sorted_by_phrase(glossary_dict)

# Check if properly printing
#print(glossary_sorted_by_phrase_string)

# Write to a text file
with open('GDA_Glossary_Sorted_By_Phrase.txt', 'w') as file:
    file.write(glossary_sorted_by_phrase_string)
