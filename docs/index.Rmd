...
Here is the link to the [Executive Summary](https://github.com/dalealberto/Case_Study_GDA/blob/main/ExecutiveSummary/PDF.pdf).
...
ggplot(daily_activity_ids_without_sleep_record_avg, aes(x = Date, y = Steps)) +
  ...
  annotate('text', x = as.Date('2016-05-04'), y = 9100, 
