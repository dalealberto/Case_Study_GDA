---
title: 'Case Study: FitBit Fitness Tracker Data and Bellabeat’s Wellness Technology'
...
**Note:** *This is a case study for the completion of my Google Data Analytics course. All [data](https://www.kaggle.com/datasets/arashnic/FitBit/data) used are real and can be downloaded from Kaggle provided by Mobius. To view the source code to produce this work, please visit my [repository](https://github.com/ilunite/demo_GDA/tree/main?tab=readme-ov-file) on GitHub. This whole case study takes approximately 15 minutes to read thoroughly. I encourage you to skip to the [conclusion](#conclusion) section first then start from the introduction since there are a lot of code chunks embedded in this case study (for those who are interested in my process).*
...
Business Task: Analyze customer usage of smart devices to uncover trends and generate insights that can be applied to **one** Bellabeat product and improve its overall sales.
...
According to my analysis, I propose three marketing strategy recommendations for Bellabeat, each substantiated by data and accompanied by actionable steps. The focus will be on Bellabeat's *Time* watch, as the [business task](#businesstask) specifically mentions only one product.

#### <font color="purple">**1. Promote the use of Bellabeat's *Time* watch for fitness tracking to drive better health outcomes:**</font>
...
#### <font color="purple">**2. Adjust marketing strategies to fit the average schedules and peak activity times of users based on the day of the week**</font>
...
#### <font color="purple"> **3. Hightlight the sleep tracking capabilities of the *Time* watch to appeal to individuals who may not have initially considered it for its fitness-related features** </font>
